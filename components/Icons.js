const ArrowUpRight = ({ className = 'h-5 w-5', size = 24 }) => (
  <svg
...
const Play = ({ className = 'h-4 w-4', size = 24 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
const ClockIcon = ({ className = 'h-7 w-7', size = 28 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
const GlobeIcon = ({ className = 'h-7 w-7', size = 28 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
const ImageIcon = ({ className = 'h-6 w-6 text-white' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
const MovieIcon = ({ className = 'h-6 w-6 text-white' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
const LightbulbIcon = ({ className = 'h-6 w-6 text-white' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
